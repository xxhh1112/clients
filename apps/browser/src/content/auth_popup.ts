  ...
  <div class="bit-auth-wrapper">
    <div class="bit-auth">
      <?xml version="1.0" encoding="utf-8"?>
        ...
        <path d="M44.6,307.8c8.4,0,15,3.3,19.8,9.9c4.8,6.6,7.2,15.6,7.2,27.1c0,11.8-2.5,20.9-7.4,27.4c-4.9,6.5-11.6,9.7-20.1,9.7
        c-8.4,0-15-3-19.7-9.1H23l-2.6,6.3c-0.4,0.9-1.3,1.5-2.3,1.5H7.3c-1.4,0-2.5-1.1-2.5-2.5v-94.4c0-1.4,1.1-2.5,2.5-2.5h14.5
        c1.4,0,2.5,1.1,2.5,2.5v20.6c0,2.9-0.3,7.6-0.8,14.1h0.8C28.9,311.4,35.6,307.8,44.6,307.8z M38.3,323.4c-4.8,0-8.3,1.5-10.5,4.4
        c-2.2,3-3.4,7.8-3.4,14.7v2.1c0,7.7,1.1,13.2,3.4,16.5c2.3,3.3,5.9,5,10.8,5c4,0,7.2-1.8,9.6-5.5c2.4-3.7,3.5-9,3.5-16.1
        c0-7-1.2-12.3-3.6-15.8C45.7,325.2,42.4,323.4,38.3,323.4z M103.7,380.6H89.2c-1.4,0-2.5-1.1-2.5-2.5v-66.5c0-1.4,1.1-2.5,2.5-2.5
        h14.5c1.4,0,2.5,1.1,2.5,2.5v66.5C106.2,379.5,105.1,380.6,103.7,380.6z M156.8,366.4c2.9,0,6.3-0.5,10.2-1.6
