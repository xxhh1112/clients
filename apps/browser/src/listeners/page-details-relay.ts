...
export class NotificationBarPageDetailsRelay {
  ...
  static async messageListener(
    ...
    const notificationBarPageDetailsRelay = new NotificationBarPageDetailsRelay(autofillService);
    await notificationBarPageDetailsRelay.listen(message, sender);
  }
  ...
  async listen(message: RuntimeMessage, sender: chrome.runtime.MessageSender) {
    ...
    await this.collectPageDetails(sender);
  }

  private async collectPageDetails(sender: chrome.runtime.MessageSender) {
