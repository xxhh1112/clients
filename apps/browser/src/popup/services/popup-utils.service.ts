...
export class PopupUtilsService {
  ...
  async openViewCipherPopout(
    ...
    await this.openPopout(promptWindowPath, {
      singleActionPopoutKey: BrowserPopoutType.ViewCipher,
      senderWindowId,
    });
  }

  async closeViewCipherPopout(delayClose = 0) {
    await this.closeSingleActionPopout(BrowserPopoutType.ViewCipher, delayClose);
  }
