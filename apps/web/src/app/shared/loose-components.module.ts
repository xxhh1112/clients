...
import { CollectionEditDialogComponent as OrgCollectionEditDialogComponent } from "../organizations/manage/collection-edit-dialog/collection-edit-dialog.components";
