...
export abstract class StateService<T extends Account = Account> {
  ...
  getEnableAutoFillOverlay: (options?: StorageOptions) => Promise<boolean>;
  setEnableAutoFillOverlay: (value: boolean, options?: StorageOptions) => Promise<void>;
  getAutoFillOverlayAppearance: (options?: StorageOptions) => Promise<number>;
  setAutoFillOverlayAppearance: (value: number, options?: StorageOptions) => Promise<void>;
