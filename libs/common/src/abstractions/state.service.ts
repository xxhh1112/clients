...
export abstract class StateService<T extends Account = Account> {
  ...
  getSMOnboardingTasks: (options?: StorageOptions) => Promise<Record<string, boolean>>;
  setSMOnboardingTasks: (value: Record<string, boolean>, options?: StorageOptions) => Promise<void>;
}
