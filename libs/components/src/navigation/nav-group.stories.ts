...
export const Tree: Story<NavGroupComponent> = (args) => ({
  ...
  template: `
    <bit-nav-group text="Tree example" icon="collection" [open]="true">
      ...
      <bit-nav-item text="Level 1 - no children" route="#" icon="collection" variant="tree"></bit-nav-item>
      <bit-nav-group text="Level 1 - with children" route="#" icon="collection" variant="tree" [open]="true">
        ...
        <bit-nav-item text="Level 2 - no children" route="#" icon="collection" variant="tree"></bit-nav-item>
      </bit-nav-group>
      <bit-nav-item text="Level 1 - no children" route="#" icon="collection" variant="tree"></bit-nav-item>
    </bit-nav-group>
  `,
