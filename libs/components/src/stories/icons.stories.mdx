...
Bitwarden is **deprecating** the icon font `<i class="bwi bwi-check"></i>` in favor of an icon
component `<bit-icon name="check"></bit-icon>` that renders SVG icons under the hood.
